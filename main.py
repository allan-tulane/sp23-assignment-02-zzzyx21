...
def subquadratic_multiply(x, y):
	...
	if (x.decimal_val <= 1 and y.decimal_val <= 1):
		...
		right_s = subquadratic_multiply(x_right, y_right)
		middle = subquadratic_multiply(
		 BinaryNumber(x_left.decimal_val + x_right.decimal_val),
		 BinaryNumber(y_left.decimal_val + y_right.decimal_val))
		add = middle.decimal_val - left.decimal_val - right_s.decimal_val
		middle_s = bit_shift(BinaryNumber(add), n // 2)
		res = left_s.decimal_val + middle_s.decimal_val + right_s.decimal_val
